...
def get_breadcrumb(category):
    ...
    if category.parent is None:
        dicts['cat1'] = category.name
    elif category.parent.parent is None:
        dicts['cat2'] = category.name
        dicts['cat1'] = category.parent.name
    else:
        dicts['cat3'] = category.name
        dicts['cat2'] = category.parent.name
        dicts['cat1'] = category.parent.parent.name
